...
$ret=mysqli_query($con,"select * from  tblenquiry join tblproperty on tblproperty.Id=tblenquiry.PropertyID where tblenquiry.Status='Answer' and tblproperty.UserID='$uid' ");;
$cnt=1;
